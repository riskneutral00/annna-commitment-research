...
- **`OR-##` = open rulings.** Five open — OR-28, OR-29, OR-40, OR-41, OR-42 (OR-39 closed) — each fully defined where it is used. The numbering is non-contiguous; missing numbers were never assigned.
