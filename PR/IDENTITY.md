...
1. **It takes the work.** You tell annnä what you sold, what you promised, what you need. It does the coordination a person would otherwise do by hand — assembling the people and resources, checking the numbers, confirming with everyone. *("Collecting the documents" was struck 2026-09-13: the amended home no longer collects them — `../security/SPEC.md` §4, "Owner and guest file uploads and participant-document authentication are excluded from v1." — in this source document, which `PR/README.md` identifies as outside the PR freeze, remediation audit ROOT-03, unit U60.)* The same problem stops costing you time.
...
- Not a data business. V1 collects no customer documents at all; the sensitive answers a customer does give are separately encrypted and destroyable, and what survives a destruction is a minimal receipt, itself erasable where it identifies anyone. *(Reworded 2026-09-13 to the retained receipt-only promise its home now states — `../security/SPEC.md` §4, "The receipt survives destruction as minimal class/event/policy evidence and an honest tombstone", "never a claim that all receipts are harmless forever" — in this source document, which `PR/README.md` identifies as outside the PR freeze, remediation audit ROOT-03, unit U60.)*
