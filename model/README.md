...
1. **`SPEC.md`** — the contract: the four calls (producer side), the intent vocabulary, ambiguity calibration, narration fidelity, judgment boundaries, voice, supply & routing (OpenRouter primary; ChatGPT-subscription slot; BYO API keys, FR5 — attended-only, FR31), failure behavior, and what this layer must never do.
