...
- Opt-in is explicit and the restrictions are structural — but who decides *what may be noticed*? The owner, or the platform?
- Is a declined offer remembered? An offer re-made after a no is a different thing from an offer made once.
- What may an accepted offer change on its own, and what must it still ask about each time?

## The floor (today, without the app)

To ask: who, today, tells this owner they are doing something inefficiently? A friend? A spreadsheet? Nobody? The floor tells us whether the offer is filling a real absence or inventing a need.
...
- Declining: what must **not** happen next.
- An offer that would change something already promised to a student must be refused or must ask — changing the rules never rewrites the past, and this is the mechanism most likely to try.

## Held-out predictions to flag, never design to

1. Whether "noticing" is a read the owner can inspect — a pattern the owner cannot see the basis of is an assertion, not an offer.
2. Whether the offer's restrictions survive the owner *wanting* more of them: a user asking to be managed harder is the pressure this design was never tested against.
