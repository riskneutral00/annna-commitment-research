...
1. The cast is Situation C's — Hug Ocean, its roster, boat, pool, gear, air — read `../Situation-C/` for who everyone is.
2. `situation-1.md` is the single run: a fresh account → the bundle stands the shop up → the clean run of Situation C starts from what it stood up → one refusal at the door.
