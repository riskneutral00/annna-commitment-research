...
*A set of user stories that stress-test **annnä** against the shape the whole lock-in thesis rests on: **one person's entire life on one board.** Matt teaches English online. His run, his gym, his meals and a personal appointment sit on the same board as his students' lessons: two regulars on a standing monthly package at times he enters himself, and two on a link-student package who book one lesson at a time from a link he pastes into their chat. There is no market here and no other business; Matt is his own resource **and** his own operator, and most of his board is his own life, which nobody books. Read this folder like a **storybook**. By the end, an LLM designing annnä should see, concretely, what the product must do: how one person sets a life down by talking, what the scattered week costs today, and where availability-blocking, self-service booking, written-not-sent messages and "I won't act for you without asking" have to show up. **annnä is the name of both the app and the agent inside it.***
...
- **The students** (customers, off-app):
  - **Mark** — hand-entered; standing Thursday 09:00–11:00; the Standing lessons package, NT$4,000 a month; one Messenger link is both his contact and his meeting link.
  - **Georgina** — hand-entered; standing Monday and Thursday 19:00–20:00; the same package; Messenger, plus a second messaging app.
  - **Kai** — the Link students package, NT$2,000 a month for up to 4 hours, from his own link, reached on LINE.
  - **Jasmine** — the Link students package, NT$2,000 a month for up to 4 hours, from her own link, reached on Instagram.

## The rules and the money

*The rules are **Matt's own**, set by talking: lessons 30 minutes to 2 hours in 15-minute steps, five-minute buffers either side, teaching 09:00–23:00 (Mondays from 15:00 after S13), online. There are two packages: **Standing lessons**, NT$4,000 a month for a weekly standing slot (Mark's Thursday, Georgina's Monday and Thursday), and **Link students**, NT$2,000 a month for up to 4 lessons and 4 hours (Kai, Jasmine). Attendance never changes a package bill. There is no credit anywhere in Matt's story. Every other money beat the earlier tellings carried — the fifth-lesson-day rule, a per-lesson rate, a rate raise, the owner's own ledger — was parked 2026-09-15 on the founder's direction; see [`parked-beats.md`](parked-beats.md). Messages to students are **written by annnä and pasted by Matt**.*
...
| [S15](story-matt.md#s15) | The packages |
...
Scene IDs are frozen. The six group scenes FD-106 retired (S08b, S13c, S13d, S13e, S14c, S14d) and S18 (parked 2026-09-15, `parked-beats.md`) are no longer defined and are never reused; the shared-request law derived from the group scenes stands at its homes and is story-owed.
...
| The monthly allowance cap and a cancellation restoring it | [S14b](story-matt.md#s14b) — Matt's 4-lesson and 4-hour limits |
| A rate change that applies only forward | parked 2026-09-15, [`parked-beats.md`](parked-beats.md) |
| "This one, or the series?" | [S16](story-matt.md#s16) |
| A no-show rule asked once and stored | parked 2026-09-15, [`parked-beats.md`](parked-beats.md) |
...
| "Who owes me what" and the monthly ledger | parked 2026-09-15, [`parked-beats.md`](parked-beats.md) |
...
| The month rolling over, a long-lived series | [S20](story-matt.md#s20); a not-yet-made instance's terms after a price change is parked 2026-09-15, [`parked-beats.md`](parked-beats.md) |
