...
**Sofia’s runs above do not force:** min-occupancy · the share seam · the travel envelope · seats · `held` money · a marketplace install. Matt’s separate scripted obligations are recorded below.

---

## Situation A — Matt English (scripted / end-state)

[Matt’s narrative](Situations/Situation-A/story-matt.md) is authorized by the narrow [FD-68 amendment](../RULINGS.md#fd-68-matt-english). It is not independent falsification evidence and does not close Sofia’s cells or the unelicited freelance/dive residue. All exact new-story compositions below are **Gap / owed**; relevant existing primitives are homes to reconcile, not proof that these scenes pass. The [companion’s layer-debt map](Situations/Situation-A/story-matt-verification.md#layer-debt) carries the detailed limits, and [cases](Situations/Situation-A/story-matt-verification.md#cases), [CRUD](Situations/Situation-A/story-matt-verification.md#crud), [cues](Situations/Situation-A/story-matt-verification.md#harness-cues) and [LEGAL-01](Situations/Situation-A/story-matt-verification.md#legal-01) preserve every transferred obligation. No v1 deferral is invented here.

| Beat / story destination | Mode | Owed layer work and existing home |
|---|---|---|
| [S01–S08a: onboarding, Routine, travel, template and note recovery](Situations/Situation-A/story-matt.md#s01) | scripted | **Gap** — app onboarding-before-account/tutorial/controls/type display at [app SPEC](../app/SPEC.md) and [design](../app/DESIGN.md); harness synchronized draft, confirmed scope and conditional elicitation at [harness SPEC](../harness/SPEC.md); engine occurrence identity, sourced route input and field/latch distinction at [engine SPEC](../engine/SPEC.md); extraction/counterexamples at [model EVALS](../model/EVALS.md); privacy and erasure at [security interfaces](../security/INTERFACES.md); truthful empty-catalog lookup, a durable private save that opens its own use, and publication as a separate explicit act at [marketplace SPEC](../marketplace/SPEC.md) §§2/6 — owed at [marketplace SCENARIOS](../marketplace/SCENARIOS.md) Z3 and [marketplace BUILD](../marketplace/BUILD.md) Step 5, whose real-catalog receipt is separate from that mocked suite (S06's lookup, S08's private save, and the companion's [HR-20](Situations/Situation-A/story-matt-verification.md#hr-20) — cited as debt, no new story). |
| [S08b–S13a: contacts, guest console, races, timezone and actual-conflict blocker](Situations/Situation-A/story-matt.md#s08b) | scripted | **Gap** — console-led automatic Student persistence, request/credential scopes and guest context at [app SPEC](../app/SPEC.md), [harness interfaces](../harness/INTERFACES.md), [security SPEC](../security/SPEC.md); identity/quota and final admission at [engine SPEC](../engine/SPEC.md); guest quarantine and restricted extraction at [model EVALS](../model/EVALS.md). Existing no-guest-agent law remains to reconcile; move/cancel pages alone do not establish a console. |
| [S13b–S13f: CRUD, groups, prices and capability limits](Situations/Situation-A/story-matt.md#s13b) | scripted | **Gap** — private save/copy/withdraw dependencies at [marketplace SPEC](../marketplace/SPEC.md); shared request and delegated coordinator operation/basis at [harness SPEC](../harness/SPEC.md); one teacher reservation, per-participant usage, atomic race/retry and already-bound quote replacement at [engine SPEC](../engine/SPEC.md); per-recipient views at [app SPEC](../app/SPEC.md) and [security interfaces](../security/INTERFACES.md); truthful capability answers at [model EVALS](../model/EVALS.md). |
| [S14–S14e: reminders, COUNT refusal/retry, participant changes and future sharing](Situations/Situation-A/story-matt.md#s14) | scripted | **Gap** — reminder grants and source-attributed reports at [harness SPEC](../harness/SPEC.md), [app SPEC](../app/SPEC.md); full corrected ledger and pending-reminder effects at [engine SPEC](../engine/SPEC.md); verified account linking and chosen sharing scopes at [security SPEC](../security/SPEC.md). No-show/erasure/dispute contracts remain owed, not universal defaults. |
