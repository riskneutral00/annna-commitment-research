...
4. **`BUILD.md`** — the ordered implementation plan (Step 0 setup → 1 atoms → 2 tool contract → 3 floor → 4 elicitation → 5 loop → 6 held-out & sign-off), each step naming its gating scenarios.
