...
| Turn-level idempotency / resume-or-abandon | `SPEC.md §5.3` (RQ-6, PRD §4.5) · write-id idempotency at `INTERFACES.md §1.2` · gated `SCENARIOS.md` X3–X4, K4 · built `BUILD.md` Step 8. *(Folded 2026-08-21.)* |
| The model exam's missing reliability metrics | `../model/EVALS.md` P-set (`pass^k` over engine state, code-graded) · qualification records the context budget. *(Folded 2026-08-21.)* |
